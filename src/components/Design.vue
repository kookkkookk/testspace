            ...
            discoveryDesignContent:[
                {
                    ...
                    "description": "建築大師庫哈斯：「建築是一種冒險 。」<br>室內設計則是整合思考，為人設計，<br>投身設計工作數十年，<br>我們從不定義自己的風格，更不盲從追求流行，<br>當設計師像明星一樣走進大眾生活，<br>我們依然默默耕耘每一件作品，<br>也許是我們的個性，也或許是我們習慣以作品發聲。",
            ...
            discoveryDesignContentMobile:[
                {
                    ...
                    "mobileDescription1": "建築大師庫哈斯：「建築是一種冒險 。」<br>室內設計則是整合思考，為人設計，投身設計工作數十年，我們從不定義自己的風格，更不盲從追求流行，當設計師像明星一樣走進大眾生活，我們依然默默耕耘每一件作品，也許是我們的個性，也或許是我們習慣以作品發聲。",
                    ...
                    <div class="choiceContentRight">
                        <div>
                            ...
                            <p data-aos="fade-right" v-else>
                                ...
                                對我們來說，每個祝福都是獨一無二，從選材到搭配，甚至重新設計包材，每年絞盡腦汁，求新求變，藉由轉用與重新組合，傳達心意的重量。
                            </p>
                        </div>
                    </div>
                </div>
